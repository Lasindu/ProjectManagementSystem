...
//import com.pms.event.DashboardEvent.PostViewChangeEvent;
import com.pms.event.DashboardEventBus;
import com.pms.view.DashboardViewType;
...
public class DashboardNavigator extends Navigator {
    ...
    public DashboardNavigator(final ComponentContainer container) {
        ...
        if (TRACKER_ID != null && host.endsWith("Project-Management-System")) {
